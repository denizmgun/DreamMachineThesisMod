...
public class MITest extends AppCompatActivity {


    public static final String EXTRAS_DEVICE_NAME = "DEVICE_NAME";
    public static final String EXTRAS_DEVICE_ADDRESS = "DEVICE_ADDRESS";
    public static final String EXTRAS_DEVICE_MODEL = "DEVICE_MODEL"; // "2": old, "3": new
    private final static String TAG = MITest.class.getSimpleName();
    ...
    private void showStats(){
        ...
        AlertDialog.Builder statsDialogBuilder = new AlertDialog.Builder(MITest.this)
    ...
    private void showSaveDialog(){
        ...
        AlertDialog.Builder alertDialogBuilderUserInput = new AlertDialog.Builder(MITest.this);
    ...
    private void showConfirmDiscardDialog() {
        AlertDialog.Builder confirmDiscardDialogBuilder = new AlertDialog.Builder(MITest.this)
